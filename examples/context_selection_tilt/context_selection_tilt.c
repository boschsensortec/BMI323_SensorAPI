...
int main(void)
{
    ...
    if (rslt == BMI323_OK)
    {
        ...
        if (rslt == BMI323_OK)
        {
            /* Set feature configurations for tilt. */
            ...
            if (rslt == BMI323_OK)
            {
                ...
                if (rslt == BMI323_OK)
                {
                    ...
                    /* Map the feature interrupt for tilt. */
