...
struct bmi323_sens_config config[7];
...
static void set_feature_config(void)
{
    ...
    if (rslt == BMI323_OK)
    {
        ...
        config[3].cfg.alt_auto_cfg.alt_switch_src_select = BMI323_ALT_STEP_COUNTER;
        config[3].cfg.alt_auto_cfg.user_switch_src_select = BMI323_ALT_TAP;
...
int main(int argc, char *argv[])
{
    ...
    struct bmi323_sensor_data sensor_data[3] = { 0 };
    ...
    map_int.step_counter_out = BMI323_INT2;
    map_int.tap_out = BMI323_INT2;
    ...
    while (1)
    {
        ...
        if (feat_int_status == 1)
        {
            ...
            if (feat_int & BMI323_INT_STATUS_STEP_COUNTER)
            {
                printf("\nStep detected\n");
                ...
                printf("No of steps counted  = %ld\n", sensor_data[2].sens_data.step_counter_output);
            ...
            if (feat_int & BMI323_INT_STATUS_TAP)
            {
