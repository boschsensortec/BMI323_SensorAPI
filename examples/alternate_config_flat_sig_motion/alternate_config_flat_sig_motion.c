...
int main(void)
{
    ...
    printf("SIG-MOTION/FLAT ALTERNATE CONFIGURATION TEST\n");
        ...
        if (rslt == BMI323_OK)
        {
            ...
            if (rslt == BMI323_OK)
            {
                ...
                if (rslt == BMI323_OK)
                {
                    ...
                    map_int.sig_mot_out = BMI323_INT1;
                    ...
                    while (1)
                    {
                        ...
                        if (int_status & BMI323_INT_STATUS_SIG_MOTION)
                        {
...
static int8_t set_feature_config(struct bmi323_dev *dev)
{
    ...
    if (rslt == BMI323_OK)
    {
        ...
        config[3].cfg.alt_auto_cfg.alt_switch_src_select = BMI323_ALT_FLAT;
        config[3].cfg.alt_auto_cfg.user_switch_src_select = BMI323_ALT_SIG_MOTION;
